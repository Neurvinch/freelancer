...
const { createProposal, getProposalId, updateProposal, getSingleProposalById, clientProposals, getmyproposals } = require('../controller/proposalController');
...
router.get('/proposals/my', identifer(['freelancer']) , getmyproposals)
